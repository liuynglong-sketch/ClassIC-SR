...
class ClassSR_Model(BaseModel):
    ...
    def feed_data(self, data, need_GT=True):
        self.var_L = data['LQ'].to(self.device, non_blocking=True)
    ...
    def load(self):
        ...
        if load_path_G_branch3 is not None and load_path_G_branch1 is not None and load_path_G_branch2 is not None:
            ...
            if self.which_model in [
                'classSR_3class_fsrcnn_macinterp_net',
                'classSR_3class_fsrcnn_macinterp_v2_net',
                'classSR_3class_fsrcnn_macinterp_v3_lite_net',
                'classSR_3class_fsrcnn_macinterp_v3_mid_a_net',
                'classSR_3class_fsrcnn_macinterp_v4_addon_a_net',
                'classSR_3class_fsrcnn_macinterp_v4_addon_a_adapter_net',
                'classSR_3class_fsrcnn_macinterp_v4_addon_a_adapter_easylrhint_net',
            ]:
                self.load_network_classSR_macinterp_3class(load_path_Gs, self.netG, self.opt['path']['strict_load'])
            else:
