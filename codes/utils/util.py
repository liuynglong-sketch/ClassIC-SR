...
def cal_FLOPs(which_model,num_ress):
    if which_model =='classSR_3class_fsrcnn_net':
        ...
        # Approximate branch FLOPs (M): net1~7.9, net2~117, net3~259 + classifier overhead.
        flops = ((7.9 * num_ress[0] + 117 * num_ress[1] + 259 * num_ress[2]) / sum(num_ress)) + 7.4
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_medium_x4interp_3x3_originhard_net':
        # Branch FLOPs (M): easy current ~7.9; medium x4 feature interp + HR 3x3 ~49.8; hard original ~468.
        flops = ((7.9 * num_ress[0] + 49.8 * num_ress[1] + 468 * num_ress[2]) / sum(num_ress)) + 7.4
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_medium_2x3x3_2x3x3_originhard_net':
        # Branch FLOPs (M): easy current ~7.9; medium two-stage 3x3 tail ~145.3; hard original ~468.
        flops = ((7.9 * num_ress[0] + 145.3 * num_ress[1] + 468 * num_ress[2]) / sum(num_ress)) + 7.4
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_medium_bottleneck16_originhard_net':
        # Branch FLOPs (M): easy current ~7.9; medium MR bottleneck16 ~41.9; hard original ~468.
        flops = ((7.9 * num_ress[0] + 41.9 * num_ress[1] + 468 * num_ress[2]) / sum(num_ress)) + 7.4
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_medium_2x3x3c24_2x3x3_originhard_net':
        # Branch FLOPs (M): easy current ~7.9; medium 36->24 two-stage tail ~102.9; hard original ~468.
        flops = ((7.9 * num_ress[0] + 102.9 * num_ress[1] + 468 * num_ress[2]) / sum(num_ress)) + 7.4
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_medium_2x3x3c24_2x3x3_originhard_tinycnn_router_net':
        # Same Version A branches, TinyCNN-16 router by default: ~0.0738M MACs/patch.
        flops = ((7.9 * num_ress[0] + 102.9 * num_ress[1] + 468 * num_ress[2]) / sum(num_ress)) + 0.073752
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_medium_2x3x3c24_2x3x3_originhard_tinycnn16_router_net':
        # Same Version A branches, TinyCNN-16 router: ~0.0738M MACs/patch.
        flops = ((7.9 * num_ress[0] + 102.9 * num_ress[1] + 468 * num_ress[2]) / sum(num_ress)) + 0.073752
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_medium_2x3x3c24_2x3x3_originhard_tinycnn8_router_net':
        # Same Version A branches, TinyCNN-8 router: ~0.0287M MACs/patch.
        flops = ((7.9 * num_ress[0] + 102.9 * num_ress[1] + 468 * num_ress[2]) / sum(num_ress)) + 0.028696
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_medium_2x3x3_2x1x1_originhard_net':
        # Branch FLOPs (M): easy current ~7.9; medium MR 3x3 + HR 1x1 tail ~117.0; hard original ~468.
        flops = ((7.9 * num_ress[0] + 117.0 * num_ress[1] + 468 * num_ress[2]) / sum(num_ress)) + 7.4
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_macinterp_net':
        # Approximate branch FLOPs (M) from quick static profiling:
        # branch1~7.9, branch2~114.6, branch3~126.0 + classifier overhead.
        flops = ((7.9 * num_ress[0] + 114.6 * num_ress[1] + 126.0 * num_ress[2]) / sum(num_ress)) + 7.4
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_macinterp_v2_net':
        # branch3 hard head is upgraded; branch1/2 stay unchanged.
        flops = ((7.9 * num_ress[0] + 114.6 * num_ress[1] + 399.1 * num_ress[2]) / sum(num_ress)) + 7.4
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_macinterp_v3_lite_net':
        flops = ((7.9 * num_ress[0] + 114.6 * num_ress[1] + 155.6 * num_ress[2]) / sum(num_ress)) + 7.4
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_macinterp_v3_mid_a_net':
        flops = ((7.9 * num_ress[0] + 114.6 * num_ress[1] + 199.3 * num_ress[2]) / sum(num_ress)) + 7.4
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_macinterp_v4_addon_a_net':
        flops = ((7.9 * num_ress[0] + 114.6 * num_ress[1] + 128.4 * num_ress[2]) / sum(num_ress)) + 7.4
        percent = flops / 468
    elif which_model == 'classSR_3class_fsrcnn_macinterp_v4_addon_a_adapter_net':
        flops = ((7.9 * num_ress[0] + 114.6 * num_ress[1] + 131.1 * num_ress[2]) / sum(num_ress)) + 7.4
        percent = flops / 468
        ...
        flops = (0.82 * num_ress[0] + 1.71 * num_ress[1] + 2.60 * num_ress[2]) / sum(num_ress)
        percent = flops / 5.20
